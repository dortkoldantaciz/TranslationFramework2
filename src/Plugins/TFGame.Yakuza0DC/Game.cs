...
namespace TFGame.Yakuza0DC
{
    public class Game : YakuzaGame.Game
    {
        public override string Id => "a09d0bdc-4cdc-4f95-ac1b-bff9078bc9ea";
        public override string Name => "Yakuza 0 Director's Cut";
        ...
        private IList<GameFileContainer> Get2dpar(string path)
        {
            ...
            {
                Path = @"media\data\2dpar\sprite_e.par",
        ...
        private IList<GameFileContainer> GetAuth(string path)
        {
            ...
            {
                RelativePath = @"media\data\auth_w64_j",
        ...
        private GameFileContainer GetFontpar()
        {
            ...
            {
                Path = @"media\data\fontpar\font_hd.par",
                Type = ContainerType.CompressedFile
            };
        ...
        private IList<GameFileContainer> GetMinigame()
        {
            ...
            var dllSearch =
                ...
                {
                    RelativePath = "w64",
                    SearchPattern = "yakuza_minigame_w64_d3d12_steamrelease.dll;yakuza_minigame_w64_d3d12_steamretail.dll",
                    IsWildcard = false,
                    RecursiveSearch = false,
