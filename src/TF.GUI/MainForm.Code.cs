    ...
    partial class MainForm
    {
...
#else
                    MessageBox.Show($"The folder {workFolder} is not empty. You must choose an empty folder.", "Attention", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                    return;
#endif
                }
            }
            ...
            if (_project != null)
            {
                if (_currentFile != null)
                {
                    if (_currentFile.NeedSaving)
                    {
                        var result = MessageBox.Show(
                            "Changes need to be saved before continuing.\nDo you want to save them?",
                ...
                workForm.DoWork += (sender, args) =>
                {
                    ...
                    try
                    {
                        ...
                        worker.ReportProgress(-1, $"Exported files are in {_project.ExportFolder}");
                    }
                    catch (UserCancelException)
                    {
                        args.Cancel = true;
        ...
        private void ExportTexts()
        {
            if (_project != null)
            {
                ...
                FolderBrowserDialog.Description = "Select the folder where Po files will be saved";
                ...
                var workForm = new WorkingForm(dockTheme, "Export to Po");
                ...
                workForm.DoWork += (sender, args) =>
                {
                    ...
                    try
                    {
                        ...
                        worker.ReportProgress(-1, "DONE");
                        worker.ReportProgress(-1, string.Empty);
                        worker.ReportProgress(-1, $"Exported files are in {FolderBrowserDialog.SelectedPath}");
#if !DEBUG
                    }
        ...
        private void ExportImages()
        {
            if (_project != null)
            {
                ...
                FolderBrowserDialog.Description = "Select the folder where images will be saved";
                FolderBrowserDialog.ShowNewFolderButton = true;
        ...
        private void ImportTexts()
        {
            if (_project != null)
            {
                ...
                FolderBrowserDialog.Description = "Select the root folder with Po files";
        ...
        private void ImportImages()
        {
            if (_project != null)
            {
                ...
                FolderBrowserDialog.Description = "Select the root folder with images";
                FolderBrowserDialog.ShowNewFolderButton = false;
                ...
                var workForm = new WorkingForm(dockTheme, "Import Images");
        ...
        {
            ImportTextsFromExcel();
        }

        private void ExportTextsToExcel()
        {
            if (_project != null)
            {
                if (_currentFile != null)
                ...
                FolderBrowserDialog.Description = "Select the folder to save Excel files";
                FolderBrowserDialog.ShowNewFolderButton = true;
                ...
                var workForm = new WorkingForm(dockTheme, "Export to Excel");
        ...
        private void ImportTextsFromExcel()
        {
            if (_project != null)
            {
                if (_currentFile != null)
                ...
                FolderBrowserDialog.Description = "Select the root folder with Excel files";
                FolderBrowserDialog.ShowNewFolderButton = false;
                ...
                var workForm = new WorkingForm(dockTheme, "Import Excel");
        ...
        private void mniBulkAllExport_Click(object sender, EventArgs e)
        {
            ExportAll();
        }

        private void mniBulkAllImport_Click(object sender, EventArgs e)
        {
            ImportAll();
        }
        ...
        private void ExportAll()
        {
            if (_project != null)
            {
                ...
                FolderBrowserDialog.Description = "Select the folder to export all files";
                FolderBrowserDialog.ShowNewFolderButton = true;
                ...
                var workForm = new WorkingForm(dockTheme, "Export All");
                ...
                workForm.DoWork += (sender, args) =>
                {
                    ...
                    {
#endif
                        _project.ExportAll(FolderBrowserDialog.SelectedPath, worker);
        ...
        private void ImportAll()
        {
            if (_project != null)
            {
                ...
                FolderBrowserDialog.Description = "Select the root folder with files to import";
                FolderBrowserDialog.ShowNewFolderButton = false;
                ...
                var workForm = new WorkingForm(dockTheme, "Import All");
                ...
                workForm.DoWork += (sender, args) =>
                {
                    ...
                    try
                    {
                        _project.ImportAll(FolderBrowserDialog.SelectedPath, worker);
