namespace TF.GUI.Forms
{
    partial class ExportProjectForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.gbExportItems.Text = "Items to export";
            // 
            // btnOnlyModified
            // 
            ...
            this.btnOnlyModified.Text = "Modified only";
            ...
            this.chkSaveTempFiles.Text = "Save temporary files";
            this.toolTip1.SetToolTip(this.chkSaveTempFiles, "[DEBUG] Select this option if you want to keep the generated temporary files.");
            ...
            this.chkForceRebuild.Text = "Force rebuild";
            this.toolTip1.SetToolTip(this.chkForceRebuild, "[DEBUG] Select this option if you want the application to generate translation files even if they have no changes from the original.");
